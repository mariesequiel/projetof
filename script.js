// Seleciona o canvas no HTML e o contexto 2D para desenhar no canvas rs
...
function getColorForNumber(number) {
    switch(number) {
        ...
        case 6: return "#00ffff"; // Ciano para 6 bombas ao redor
        case 7: return "#ff00ff"; // Magenta para 7 bombas ao redor
